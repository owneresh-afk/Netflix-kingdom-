...
def after_account_keyboard(redemption_id: int):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("❌ Not Working", callback_data=f"not_working_{redemption_id}")],
        [InlineKeyboardButton("📸 Submit Proof", callback_data=f"submit_proof_{redemption_id}")],
